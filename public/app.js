...
},{"global/document":30,"hyperx":33,"on-load":59}],27:[function(require,module,exports){
...
},{"assert":58,"global/document":30,"global/window":31}],60:[function(require,module,exports){
(function (process){
...
},{"isarray":56}],62:[function(require,module,exports){
...
},{"../translate":85,"yo-yo":69}],72:[function(require,module,exports){
'use strict';
...
},{"../translate":85,"yo-yo":69}],73:[function(require,module,exports){
'use strict';
...
page('/', header, loadPicturesFetch, function (ctx, next) {
    ...
    var $pictures = [user, user, user, user, user];
...
},{"../header":72,"./template.js":74,"axios":1,"empty-element":29,"page":60,"superagent":64,"yo-yo":69}],74:[function(require,module,exports){
'use strict';
...
},{"./footer":71,"./homepage":73,"./signin":79,"./signup":81,"page":60}],76:[function(require,module,exports){
'use strict';
...
},{"../translate":85,"yo-yo":69}],78:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['\n      <div class="card ', '">\n      <div class="card-image waves-effect waves-block waves-light">\n        <img class="activator" src="public/img/', '">\n      </div>\n      <div class="card-content">\n        <a href="/user/', '" class="card-title activator ">\n          <img src="public/img/', '" class="avatar" />\n          <span class="username">', '</span>\n        </a>\n        <small class="right time">', '</small>\n        <p>\n          <a class="left" href="#" disabled="true" onclick=', '><i class="far fa-heart"></i></a>\n          <a class="left" href="#" disabled="true" onclick=', '><i class="fas fa-heart"></i></a>\n          <span class="left likes"> ', '</span>\n        </p>\n      </div>\n      </div>\n      '], ['\n      <div class="card ', '">\n      <div class="card-image waves-effect waves-block waves-light">\n        <img class="activator" src="public/img/', '">\n      </div>\n      <div class="card-content">\n        <a href="/user/', '" class="card-title activator ">\n          <img src="public/img/', '" class="avatar" />\n          <span class="username">', '</span>\n        </a>\n        <small class="right time">', '</small>\n        <p>\n          <a class="left" href="#" disabled="true" onclick=', '><i class="far fa-heart"></i></a>\n          <a class="left" href="#" disabled="true" onclick=', '><i class="fas fa-heart"></i></a>\n          <span class="left likes"> ', '</span>\n        </p>\n      </div>\n      </div>\n      ']);
...
module.exports = function (pic) {
  ...
  function render(picture) {
    return yo(_templateObject, picture.liked ? 'liked' : 'disliked', picture.url, picture.user.username, picture.user.avatar, picture.user.username, translate.date.format(picture.createdAt), like.bind(null, true), like.bind(null, false), translate.message('likes', { likes: picture.likes }));
  }
  var like = function like(liked) {
    pic.liked = liked;
    pic.likes += liked ? 1 : -1;
...
},{"../translate":85,"yo-yo":69}],79:[function(require,module,exports){
'use strict';
...
},{"./template.js":80,"empty-element":29,"page":60,"yo-yo":69}],80:[function(require,module,exports){
'use strict';
...
var $signinForm = yo(_templateObject, translate.message('signup.subheading'), translate.message('signup.facebook'), translate.message('username'), translate.message('password'), translate.message('signup.text'), translate.message('signin.not-have-account'), translate.message('signin'));
module.exports = landing($signinForm);

},{"../landing":76,"../translate":85,"yo-yo":69}],81:[function(require,module,exports){
'use strict';
...
},{"./template.js":82,"empty-element":29,"page":60,"yo-yo":69}],82:[function(require,module,exports){
'use strict';
...
},{"../landing":76,"../translate":85,"yo-yo":69}],83:[function(require,module,exports){
'use strict';
...
},{"./en-US":83,"./es":84,"intl":51,"intl-messageformat":36,"intl-relativeformat":45,"intl-relativeformat/dist/locale-data/en.js":43,"intl-relativeformat/dist/locale-data/es.js":44,"intl/locale-data/jsonp/en-US.js":53,"intl/locale-data/jsonp/es.js":54}]},{},[75]);
